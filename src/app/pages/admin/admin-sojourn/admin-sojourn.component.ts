...
@Component({
  selector: 'app-sojourn-room',
  standalone: true,
  imports: [CommonModule, ModalComponent, SojournFormComponent],
  templateUrl: './admin-sojourn.component.html',
  styleUrl: './admin-sojourn.component.scss',
})
export class AdminSojournComponent implements OnInit {
